            ...
            do {
                ...
                if session.disabledRequestTypes.contains(requestType) {
                    ...
                    handleCompletion(
                        ...
                        error: NSError.tentaclesError(code: .requestTypeDisabledError, localizedDescription: "The \(requestType.rawValue) request type has been disabled by the client"),
                        responseType: responseType,
                        requestType: requestType)
                ...
                if Tentacles.shared.networkingMode == .simulatedOffline {
                    ...
                    handleCompletion(
                        data: nil,
                        urlResponse: httpResponse,
                        error: NSError.tentaclesError(code: .simulatedOfflineError, localizedDescription: "The Internet connection appears to be offline."),
                        responseType: responseType,
                        requestType: requestType)
                ...
                if cachedOnly {
                    ...
                    handleCompletion(
                        data: nil,
                        urlResponse: httpResponse,
                        error: NSError.tentaclesError(code: .cachedNotFoundError, localizedDescription: "Requested cached response not found"),
                        responseType: responseType,
                        requestType: requestType)
